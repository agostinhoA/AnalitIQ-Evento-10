...
public final class BusquedaSesion implements Serializable {
    ...
    public synchronized String agregar(List<Paciente> pacientes, FiltrosDeuda filtros,
        ...
        return agregarFlujo(pacientes,filtros,criterio,ahora,dni);
    }
    private String agregarFlujo(List<Paciente> pacientes, FiltrosDeuda filtros,
        ...
        flujos.put(id,new Flujo(pacientes,filtros,criterio,ahora,dni));
        return id;
    }
    ...
    public static final class Flujo implements Serializable {
        ...
        private Flujo(List<Paciente> pacientes,FiltrosDeuda filtros,CriterioBusqueda criterio,Instant creado,String dni) {
