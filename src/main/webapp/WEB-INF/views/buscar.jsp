...
<p class="muted" id="criterio-ayuda">Completá el DNI <strong>o</strong> el nombre y apellido juntos. Dejá los tres campos vacíos para elegir entre los pacientes con cuotas pendientes según el tratamiento y las fechas que indiques.</p>
<div class="identification-fields">
<div><label for="dni">DNI</label><input class="field-short" id="dni" name="dni" type="text" inputmode="numeric" maxlength="8" placeholder="Ej. 30111222" value="<c:out value='${dniValor}'/>" aria-describedby="criterio-ayuda"><small>7 u 8 dígitos, sin puntos.</small></div>
<div class="two-columns"><div><label for="nombre">Nombre</label><input class="field-medium" id="nombre" name="nombre" maxlength="100" placeholder="Ej. Juan" value="<c:out value='${nombreValor}'/>"></div><div><label for="apellido">Apellido</label><input class="field-medium" id="apellido" name="apellido" maxlength="100" placeholder="Ej. Pérez" value="<c:out value='${apellidoValor}'/>"></div></div>
