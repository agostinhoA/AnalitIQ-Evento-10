...
<section class="panel menu-card"><span class="menu-number">02 / INFORMES</span><h2>Ver informe de deudas</h2><p>Consultá las cuotas pendientes de los tratamientos de un paciente, filtradas por fecha de vencimiento.</p><a class="button secondary" href="<c:url value='/deudas'/>">Consultar informe →</a></section>
</div>
